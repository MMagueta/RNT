...
The easiest Unix path is the Nix development shell. It provides CMake, Ninja,
SQLite, PicoSHA2 headers, Catch2, and debugger tooling.

#+begin_src shell
cd /Users/mmagueta/Developer/RNT
nix develop
cmake -S . -B _build -G Ninja -DCMAKE_BUILD_TYPE=Debug
